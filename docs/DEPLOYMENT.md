...
5. Run frontend unit tests in Docker with `make test-frontend-docker`.
6. Stop the deployment test stack with `make down`.
7. Stop the application stack with `make fullstack-down`.
